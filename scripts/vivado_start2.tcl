...
# RTL source files — add all your .v / .sv files here
# RIGHT NOW this uses the behavioral stubs so the script runs immediately.
# When you have real RTL, replace streaming_nn_system_stub.sv with your files.
set RTL_FILES {
...
# but have .v extensions — override the file type so Vivado parses them as SV.
...
# ===========================================================================
banner "Step 3: Synthesis  (RTL -> gates)  [may take 2-5 minutes]"
...
# ===========================================================================
banner "Step 4: Implementation  (place & route)  [may take 5-15 minutes]"
...
set luts  [get_property USED [get_cells -hierarchical -filter {REF_NAME=~LUT*}  2>/dev/null] 2>/dev/null]
