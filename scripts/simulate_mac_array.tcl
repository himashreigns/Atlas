# Simulation Script for mac_array unit test
set project_dir "./vivado_project"
set project_name "stream_processing_final"
set tb_file "tb/tb_mac_array.v"
...
puts "Adding mac_array testbench to simulation fileset..."
if {[file exists $tb_file]} {
    add_files -fileset sim_1 $tb_file
    set_property file_type SystemVerilog [get_files $tb_file]
    update_compile_order -fileset sim_1
    set_property top tb_mac_array [get_filesets sim_1]
} else {
    puts "ERROR: Testbench file not found: $tb_file"
    return
}

puts "Running mac_array behavioral simulation..."
