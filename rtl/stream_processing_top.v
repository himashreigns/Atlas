...
module stream_processing_top #(
    ...
    parameter MODE = "FIXED_PIPELINE",  // "FIXED_PIPELINE" or "RECONFIGURABLE"
        ...
        if (rst) begin
            ...
            if (ctrl_rvalid) begin
                ...
                case (ctrl_addr)
                    ...
                    ADDR_CONFIG: begin
                        ctrl_rdata_reg <= {24'd0, NUM_LAYERS[7:0]};
                    end
    ...
    generate
        if (MODE == "FIXED_PIPELINE") begin : FIXED_MODE
        ...
        end else if (MODE == "RECONFIGURABLE") begin : RECONFIG_MODE
