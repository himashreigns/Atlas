...
module tb_system_stress;
    ...
    initial begin
        ...
        expected[0] = 32'h0000AA00;
        expected[1] = 32'h0000AA00;
        expected[2] = 32'h0000AA00;
        expected[3] = 32'h0000AA00;
        expected[4] = 32'h0000AA00;
        expected[5] = 32'h00000000;
        expected[6] = 32'h00000000;
        expected[7] = 32'h00000000;
        expected[8] = 32'h00000000;
        expected[9] = 32'h00000000;
        expected[10] = 32'h00000000;
        expected[11] = 32'h00000000;
        expected[12] = 32'h00000000;
        expected[13] = 32'h00000000;
        expected[14] = 32'h00000000;
        expected[15] = 32'h00000000;
        expected[16] = 32'h00000000;
        expected[17] = 32'h00000000;
